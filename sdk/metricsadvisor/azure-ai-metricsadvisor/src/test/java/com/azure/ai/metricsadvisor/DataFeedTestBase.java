    ...
    void creatDataFeedRunner(Consumer<DataFeed> testRunner, DataFeedSourceType dataFeedSourceType) {
        ...
        switch (dataFeedSourceType) {
            case AZURE_APP_INSIGHTS:
                ...
                break;
            case AZURE_BLOB:
                dataFeed = new DataFeed().setSource(AzureBlobDataFeedSource.usingBasicCredential(BLOB_CONNECTION_STRING,
            ...
            case AZURE_COSMOS_DB:
                dataFeed = new DataFeed().setSource(new AzureCosmosDataFeedSource(
