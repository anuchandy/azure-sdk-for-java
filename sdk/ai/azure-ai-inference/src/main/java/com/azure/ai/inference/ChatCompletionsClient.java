...
import com.azure.ai.inference.implementation.ChatCompletionAPITracer;
...
public final class ChatCompletionsClient {
    ...
    private final ChatCompletionAPITracer tracer;
    ...
    ChatCompletionsClient(ChatCompletionsClientImpl serviceClient) {
        ...
        this.tracer = ChatCompletionAPITracer.load(this.serviceClient.getEndpoint());
    }
    ...
    public ChatCompletions complete(ChatCompletionsOptions options) {
        ...
        ChatCompletionAPITracer.CompleteOperation operation
    ...
    public IterableStream<StreamingChatCompletionsUpdate> completeStream(ChatCompletionsOptions options) {
        ...
        final ChatCompletionAPITracer.StreamingCompleteOperation operation
