...
final class ChatCompletionClientTracer {
     ...
     */
    ChatCompletionClientTracer(String endpoint, ClientOptions clientOptions) {
    ...
    ChatCompletions syncTraceComplete(ChatCompletionsOptions request, SyncCompleteOperation operation,
